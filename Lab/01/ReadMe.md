...
root.mainloop()
```
6. Скриншот графического интерфейса клиентского приложения: <br>
![](./image/01.png)
<p> Рисунок 1 - Интерфейс клиентского приложения <br>
7. Скриншот браузера с загруженными виджетом: <br>

![](./image/02.png)
<p> Рисунок 2 - HTML виджет в браузере <br>
<h2> Вывод </h2>
